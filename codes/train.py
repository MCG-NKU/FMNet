...
def valid(val_loader, model, opt, logger):
    ...
    for val_data in val_loader:
        ...
        psnr = extra_util.calculate_psnr(img1=hq_ndy_bgr, img2=gt_ndy_bgr) # 10
        ssim = extra_util.calculate_ssim(img=hq_ndy_bgr * 255, img2=gt_ndy_bgr * 255) # 10
        deltaITP = extra_util.calculate_hdr_deltaITP(img1=hq_ndy_bgr, img2=gt_ndy_bgr) # 10
        avg_psnr += psnr
        avg_ssim += ssim
